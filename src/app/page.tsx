...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#050505] selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black font-sans flex flex-col text-gray-900 transition-colors duration-300 relative z-0">
      ...
      {/* 1. NAVIGATION BAR — full-width sticky wrapper with backdrop */}
      <div className="sticky top-0 z-50 w-full bg-[#FAFAFA]/90 dark:bg-[#050505]/90 backdrop-blur-md border-b border-gray-200/40 dark:border-white/5 transition-colors duration-300">
        <nav className="flex items-center justify-between px-5 md:px-12 py-4 md:py-5 max-w-7xl mx-auto w-full">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 md:w-10 md:h-10 bg-black dark:bg-white rounded-xl flex items-center justify-center shadow-md transform transition-all hover:scale-110 hover:shadow-lg duration-300 group cursor-pointer shrink-0">
              <div className="w-3 h-3 md:w-3.5 md:h-3.5 bg-white dark:bg-black rounded-sm rotate-45 transform group-hover:rotate-90 transition-transform duration-500" />
            </div>
          ...
          <div className="flex items-center gap-2 md:gap-6 text-sm font-medium">
            <Link href="/login" className="text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors duration-200 cursor-pointer tracking-wide px-2 py-1.5 whitespace-nowrap">
              Sign In
            </Link>
            <Link
              href="/register"
              className="bg-black dark:bg-white text-white dark:text-black px-4 md:px-6 py-2 md:py-2.5 rounded-xl hover:bg-gray-900 dark:hover:bg-gray-100 hover:scale-[1.03] active:scale-95 cursor-pointer font-bold text-sm transition-all duration-200 shadow-md hover:shadow-lg whitespace-nowrap"
            >
              Get Started
            </Link>
          </div>
